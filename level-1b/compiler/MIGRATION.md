...
| `lower_ast.chiba` | `compiler/lower/ast_to_core.chiba` | partial rewrite: SurfaceModule lowering boundary owned; per-item AST lowering pending |
...
| `type_template.chiba` | `compiler/semantic/template.chiba` | partial rewrite: template pass boundary and typed-fact obligation collection rewritten; full template body scan pending |
